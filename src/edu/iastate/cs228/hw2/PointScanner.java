...
public class PointScanner
{
	...
	protected PointScanner(String inputFileName, Algorithm algo) throws FileNotFoundException, InputMismatchException
	{
		...
		try
		{
			...
			while (sc.hasNextInt())
			{
				...
				if (sc.hasNextInt())
				{
					Point newPoint = new Point(xValue, sc.nextInt());
					points[i] = newPoint;
					i++;
				}
				else
	...
	public String stats()
	{
		...
		returnString += " " + points.length + " " + scanTime;
		return returnString;
	...
	{
		this.medianCoordinatePoint.toString();
	}
